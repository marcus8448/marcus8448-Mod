...
public class BiomeMarcus8448 extends Biome {
	...
	private final IBlockState Box = Blocks.BLUE_SHULKER_BOX.getDefaultState();
	private final IBlockState Terra = Blocks.BLUE_GLAZED_TERRACOTTA.getDefaultState();
	private final IBlockState Obs = Blocks.OBSIDIAN.getDefaultState();
    ...
    public BiomeMarcus8448(Biome.BiomeProperties BP)
    {
    	...
    	super(BP.setWaterColor(rgb));
    	this.topBlock = Blocks.GRASS.getDefaultState();
    	this.setRegistryName(Constants.MODID, "marcus_biome");
    	this.fillerBlock = com.marcus8448.mod.blocks.Blocks.BLUE_OAK_PLANKS.getDefaultState();
    	MarcusModBiomes.BIOMES.add(this);
        ...
        this.flowers.clear();
        this.flowers.add(new Biome.FlowerEntry(Box, 10));
        this.flowers.add(new Biome.FlowerEntry(Terra, 20));
        this.flowers.add(new Biome.FlowerEntry(Obs, 15));
    ...
    public int setWaterColor(int C) {
    	return 12446975;
    }

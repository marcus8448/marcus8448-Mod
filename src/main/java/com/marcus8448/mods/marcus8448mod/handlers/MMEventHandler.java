...
import com.marcus8448.mods.marcus8448mod.Config;
        ...
        if (entity instanceof EntityPlayerMP) {
            ...
            if (Config.sendMessageOnStartup) {
                TextComponentString message = new TextComponentString(
                        "§9Thank you for installing §lMarcus' Mod§9 for " + Constants.MCV + ". Go to§6 ");

                // playerMP.sendMessage(new TextComponentString("§9Thank you for installing
                // §lMarcus' Mod§9 for " + Constants.MCV + ". Go to§6
                // https://github.com/marcus8448/Marcus8448-Mod/issues/ §9to submit an
                // §c§lissue§9 if you find one."));
                ITextComponent componentIssueLink = new TextComponentString(
                        "https://github.com/marcus8448/Marcus8448-Mod/issues/");
                Style styleLink = new Style();
                styleLink.setUnderlined(Boolean.TRUE);
                styleLink.setColor(TextFormatting.GOLD);
                styleLink.setClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL,
                        "https://github.com/marcus8448/Marcus8448-Mod/issues"));
